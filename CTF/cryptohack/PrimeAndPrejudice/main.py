...
#     if found:
#         break
arr = [1030617353352977080364307518770663528633732979071959749923, 1028807953088414986212097163368256369521677751668451001002928690467, 240133843331243659724883651873564602171659784123766621731827]
n = arr[0] * arr[1] * arr[2]
print(miller_rabin(n, 64))
print(n.bit_length())
print(pow(n - arr[0], n - 1, n))
send = {'prime': n, 'base': n - arr[0]}
